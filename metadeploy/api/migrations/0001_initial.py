# Generated by Django 2.1.1 on 2018-09-28 20:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("slds_icon_name", models.CharField(blank=True, max_length=64)),
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="api.ProductCategory"
            ),
        ),
        migrations.AddField(
            model_name="plan",
            name="version",
            field=models.ForeignKey(
                on_delete=django.db.models.deletion.PROTECT, to="api.Version"
            ),
        ),
        migrations.AddField(
            model_name="job",
        ...
        migrations.AddField(
            model_name="job", name="steps", field=models.ManyToManyField(to="api.Step")
        ),
        migrations.AddField(
            model_name="job",
            name="user",
        ...
        migrations.AlterUniqueTogether(
            name="version", unique_together={("product", "label")}
        ),
    ]
