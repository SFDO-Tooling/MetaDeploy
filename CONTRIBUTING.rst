...
Edit this file to change ``DJANGO_SECRET_KEY`` and
``DJANGO_HASHID_SALT`` to any two different arbitrary string values, and
to edit the following environment variables (if you're an OddBird, you
