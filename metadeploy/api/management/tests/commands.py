...
def test_run_plan(plan_factory):
    ...
    with ExitStack() as stack:
        ...
        stack.enter_context(patch("metadeploy.api.salesforce.OrgConfig.refresh_oauth_token"))
        stack.enter_context(patch("cumulusci.core.flowrunner.PreflightFlowCoordinator.run"))
