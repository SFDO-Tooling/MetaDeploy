...
step. If it's possible to install the `Plan` into a `Scratch Org`,
**"Create Scratch Org"** will be the first step. If both options are possible,
both will be listed in the first step.
