...
import { completePreflight, failPreflight } from 'plans/actions';
import { invalidateToken } from 'accounts/actions';
import { log } from 'utils/logging';

import type { Dispatch } from 'redux-thunk';
import type { Preflight } from 'plans/reducer';
import type { PreflightCompleted, PreflightFailed } from 'plans/actions';
...
): TokenInvalidAction | PreflightCompleted | PreflightFailed | null => {
  switch (msg.type) {
