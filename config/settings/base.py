...
AWS_ACCESS_KEY_ID = env("BUCKETEER_AWS_ACCESS_KEY_ID", env("AWS_ACCESS_KEY_ID"))
AWS_SECRET_ACCESS_KEY = env(
    "BUCKETEER_AWS_SECRET_ACCESS_KEY", env("AWS_SECRET_ACCESS_KEY")
)
AWS_STORAGE_BUCKET_NAME = env("BUCKETEER_BUCKET_NAME", env("AWS_BUCKET_NAME"))
