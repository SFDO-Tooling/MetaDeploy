...
Load MetaDeploy
    ...
    Capture Page Screenshot  ${OUTPUTDIR}/${LANG}/{index}.png
...
Log in to Org
    ...
    ${needs_oauth_approval}=  Run Keyword And Return Status    Element Should Be Visible   css:#oaapprove
...
Maybe Run Preflight
    ...
    ${has_preflight} =  Run Keyword and Return Status  Wait Until Page Contains Element  //button[text()="${text1}"]|//button[text()="${text2}"]  timeout=5
